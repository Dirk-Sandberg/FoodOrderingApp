...
class ExpansionPanel(TwoLineAvatarIconListItem):
...
class MDExpansionPanel(BoxLayout):
    ...
    def on_open(self, *args):
        #self.check_open_box(self.ids.item_anim)
        #self.check_open_box(self.ids.item_anim)
        pass
    ...
    def foo(self, *args):
        ...
        anim.bind(on_complete=self.make_content_visible)
        anim.start(self)
    def make_content_visible(self, *args):
        if self.content:
